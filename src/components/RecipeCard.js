...
const RecipeCard = ({item, detail}) => {
  ...
  return (
    <TouchableOpacity
      ...
      <Text style={{color: theme.colors.secondary}}>{item.dishTypes[0]}</Text>
      ...
      <View
        ...
        <Text>{item.readyInMinutes} minute</Text>
        <Icon name="pot-mix-outline" type="material-community" />
        <Text>{item.servings} serving</Text>
      </View>
    </TouchableOpacity>
  );
};
